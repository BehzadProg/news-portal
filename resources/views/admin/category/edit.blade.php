...
@section('title', __('admin_localize.Edit Category'))
@section('content')
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>{{__('admin_localize.Edit Category')}}</h4>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <select name="language"  class="form-control select2">
                                            ...
                                            <option {{$language->lang === $category->language ? 'selected' : ''}} value="{{$language->lang}}">{{$language->name}}</option>
                                            @endforeach
                                        </select>
                                        @error('language')
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <select name="show_at_nav" class="form-control selectric">
                                            ...
                                            <option {{$category->show_at_nav === 0 ? 'selected' : ''}} value="0">{{__('admin_localize.No')}}</option>
                                            <option {{$category->show_at_nav === 1 ? 'selected' : ''}} value="1">{{__('admin_localize.Yes')}}</option>
                                        </select>
                                        @error('default')
                                        <p class="text-danger">{{$message}}</p>
                                        @enderror
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                      <select name="status" class="form-control selectric">
                                        ...
                                        <option {{$category->status === 1 ? 'selected' : ''}} value="1">{{__('admin_localize.Active')}}</option>
                                        <option {{$category->status === 0 ? 'selected' : ''}} value="0">{{__('admin_localize.InActive')}}</option>
                                      </select>
                                      @error('status')
                                        <p class="text-danger">{{$message}}</p>
                                        @enderror
