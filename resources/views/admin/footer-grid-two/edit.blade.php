...
@section('title', __('admin_localize.Edit Footer Grid Two Links'))
@section('content')
    <section class="section">
        <div class="section-header">
            ...
            <h1>{{__('admin_localize.Footer Grid Two Links')}}</h1>
        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>{{__('admin_localize.Edit Footer Grid Two Link')}}</h4>
                        </div>
                        <div class="card-body">
