        ...
        <div class="card-body">
            <form action="{{route('admin.seo-setting.update')}}" method="post">
                ...
                <div class="form-group row mb-4">
                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">{{__('admin_localize.Site Seo Title')}}</label>
                ...
                <div class="form-group row mb-4">
                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">{{__('admin_localize.Site Seo Description')}}</label>
                    <div class="col-sm-12 col-md-7">
                ...
                <div class="form-group row mb-4">
                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">{{__('admin_localize.Site Seo Keywords')}}</label>
                    <div class="col-sm-12 col-md-7">
