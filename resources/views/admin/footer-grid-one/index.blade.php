                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            ...
                            <div class="card-header-action">
                                <a href="{{ route('admin.footer-grid-one.create') }}" class="btn btn-primary">{{__('Create New')}} <i
                        ...
                        <div class="card-body">
                                ...
                                <div class="tab-content tab-bordered" id="myTab3Content">
                                    @foreach ($languages as $language)
                                    @php
                                        $footers = \App\Models\FooterGridOne::where('language' , $language->lang)->orderByDesc('id')->get()
                                    @endphp
                                        ...
                                        <table class="table table-striped" id="table-{{$language->lang}}">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{route('admin.footer-grid-one.edit' , $footer->id)}}" class="btn btn-primary mr-2"><i class="fas fa-edit"></i></a>
                                                        <a href="{{route('admin.footer-grid-one.destroy' , $footer->id)}}" class="btn btn-danger delete-item"><i class="fas fa-trash-alt"></i></a>
                                                    </td>
