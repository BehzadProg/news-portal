...
<head>
    ...
    <title>{{__('admin_localize.Admin Reset Password')}}</title>
...
<body>
    <section>
        ...
        <div class="login">
            <h2>{{__('admin_localize.Reset Password')}}</h2>
            <form action="{{ route('admin.password.store') }}" method="post">
                ...
                <div class="inputBox">
                    ...
                    @enderror
                    <input type="email" name="email" placeholder="{{__('admin_localize.Email')}}" value="{{@request()->email}}">
                ...
                <div class="inputBox">
                    ...
                    <code style="color: red">{{ $message }}</code>
                    @enderror
                    <input type="password" name="password_confirmation" placeholder="{{__('admin_localize.Confirm Password')}}">
                </div>
                <div class="inputBox">
                    <input type="submit" value="{{__('admin_localize.Save')}}" id="btn">
                </div>
            </form>
        </div>
    </section>
