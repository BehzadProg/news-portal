...
<div class="main-sidebar sidebar-style-2">
  <aside id="sidebar-wrapper">
    ...
    <ul class="sidebar-menu">
      ...
      <li class="{{setSidebarActive(['admin.contact-message.*'])}}"><a class="nav-link {{$unReadMessages > 0 ? 'beep beep-sidebar' : ''}}" href="{{route('admin.contact-message.index')}}"><i class="fa fa-envelope"></i> <span>{{__('Contact Messages')}}</span>
