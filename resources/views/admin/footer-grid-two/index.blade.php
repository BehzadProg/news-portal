...
@section('title', __('- Footer Grid Two'))
@section('content')
                                        ...
                                        <div class="card-body">
                                            <form action="{{route('admin.footer-grid-two-title')}}" method="POST">
                                                ...
                                                <div class="form-group row mb-4">
                                                    <label
                                                        class="col-form-label text-md-right col-12 col-md-3 col-lg-3">{{ __('Footer Grid Two Title') }}</label>
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            ...
                            <div class="card-header-action">
                                <a href="{{ route('admin.footer-grid-two.create') }}" class="btn btn-primary">{{__('Create New')}} <i
